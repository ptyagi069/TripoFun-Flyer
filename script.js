function createContainerHTML(service, index) {
            ...
            <div class="col-md-8" style="border: 0.5px solid #ECECEC; border-radius: 20px; background-color: #F9F9F9;">
              <div class="activity">
                ...
                <div class="addon-info">
                  <p style="font-size: 26px; font-weight: 500; line-height: 26px; width: 70%;">${service.servicE_NAME}</p>
                  <span style="color: #00ACEA; font-weight: 700; float: right;">@ $${service.guestAmount} only</span>
                </div>
              </div>
              <div class="time-days">
        ...
        <div class="container" style="margin-bottom: 10px;">
          <div class="row">
            <div class="col-md-8" style="border: 0.5px solid #ECECEC; border-radius: 20px; background-color: #F9F9F9;">
              <div class="activity">
                <h5>Activity ${index + 1}</h5>
                <div class="addon-info" style="display: flex;">
                  <p style="font-size: 26px; font-weight: 500; line-height: 26px;">${service.servicE_NAME}</p>
                  <span style="color: #00ACEA; font-weight: 700; line-height: 26px;">@ $${service.guestAmount} only</span>
                </div>
              </div>
              <div class="time-days">
                <p style="font-weight: 700;"><img src="images/clock.png" alt="" style="width: 30px; height: 30px; margin-right: 5px;"> ${service.duration}</p>
  ...
  function fetchAddOnsDetails() {
    ...
    const requestData = { agentID: 'CHAGT0001000012263', pkG_ID: '8', year: '2024' };
